...
export default function Terms() {
  return (
    <>
      ...
      <p>
        This website is operated by Crust Mill LLC. Throughout the site, the
        terms “we”, “us” and “our” refer to Crust Mill LLC. Crust Mill LLC
      ...
      <p>
        ...
        https://www.crustmill.com/return-policy.
      </p>
      <p>
      ...
      <p>
        ...
        https://www.crustmill.com/privacy-policy.
      </p>
      ...
      <h3>Section 13 — Disclaimer of Warranties; Limitations of Liability</h3>
      ...
      <p>
        ...
        <br />
        In no case shall Crust Mill LLC, our directors, officers, employees,
      ...
      <p>
        You agree to indemnify, defend and hold harmless Crust Mill LLC and our
