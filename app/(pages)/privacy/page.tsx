...
export default function Privacy() {
  return (
    <>
      ...
      <Legalese>
        <p style={{ color: "#6C6C6C" }}>Last updated: August 19th 2024</p>

        <h3>Purpose</h3>
        <p>
          This Privacy Policy describes how Crust Mill LLC (the "Site", "we",
          "us", or "our") collects, uses, and discloses your personal
          information when you visit, use our services, or make a purchase from
          https://www.crustmill.com (the "Site") or otherwise communicate with
        ...
        <p>
          ...
          and exchanges and to enable you to post reviews. Marketing and
          ...
          promotional communications by email, text message or postal mail, and
          to show you advertisements for products or services. This may include
          using your personal information to better tailor the Services and
          advertising on our Site and other websites. Security and Fraud
          Prevention. We use your personal information to detect, investigate or
          take action regarding possible fraudulent, illegal or malicious
          activity. If you choose to use the Services and register an account,
          ...
          support and improve our Services. This is in our legitimate interests
        ...
        <p>
          Pursuant to Nevada Privacy Law (“NPL”), Nevada residents may direct a
          business that operates an internet website not to sell certain
          Personal Information about you. We do not sell your Personal
        ...
        <p>
          ...
          immediately preceding calendar year. We do not share your Personal
        ...
        <p>
          ...
          available to you, email us at info@crustmill.com.
        </p>
      </Legalese>
    </>
  );
