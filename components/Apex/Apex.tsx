          ...
          {active === "Stainless Steel" ? (
            <>
              <p className={styles.p}>
                <em>Our stainless steel burr grinder</em> is ideal for pepper
                due to its exceptional hardness and durability, easily cutting
                through tough peppercorns. Its high-precision engineering
                ensures a consistent grind, enhancing flavor release.
              </p>
              <p className={styles.p}>
                Resistant to corrosion, stainless steel burrs maintain
                performance despite the oils and moisture in pepper.
              </p>
            </>
          ) : (
            <>
              ...
              <p className={styles.p}>
                Minimal heat generation prevents clumping, maintaining the
                salt's dryness. Additionally, ceramic burrs resist corrosion,
