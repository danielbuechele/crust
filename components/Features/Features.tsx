    ...
    <section className={styles.root}>
      <Wrapper className={styles.wrapper}>
        ...
        <div className={clsx(styles.box)}>
          ...
          />
          <p>
            <strong>Compatible Spices.</strong> Usable for all dry peppers,
            salt, and spices.
          </p>
        </div>
        ...
        <div className={clsx(styles.box, styles.today)}>
          ...
          <p className={styles.shipping}>
            <strong>Free Shipping in the US.</strong> We normally ship within
            2-3 business days after receiving your order.
          </p>
        </div>
