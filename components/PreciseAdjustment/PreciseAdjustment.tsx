      ...
      <section className={styles.root}>
        <Wrapper>
          ...
          >
            ...
            spices only land where they should — in your dishes, not on the
            table. Effortlessly adjust from fine to coarse, and enjoy
            consistent, perfect grinds every time.
          </TextPairing>
